  ...
  return (
      <header className="header sticky top-0 bg-gray-800 shadow-md flex items-center justify-between px-8 py-3">
          ...
          <div className="w-3/12 flex justify-end">
                  <svg className="h-8 p-1 hover:text-green-500 duration-200 svg-inline--fa fa-search fa-w-16 fa-9x" aria-hidden="true" focusable="false"
                  ...
                  <svg className="h-8 p-1 hover:text-green-500 duration-200 svg-inline--fa fa-shopping-cart fa-w-18 fa-7x" aria-hidden="true" focusable="false"
